...
def write_to_xl(res):
        ...
        for k in uniq_foreign_key_list:
            ...
            for c in column_names:
                ...
                if k==c:
                    ...
                    break
                pos_forkey+=1
            #when foreign key exists use the above dictionary dct_pkey to add extension to primary key and dct_fkey to add extension to foreign key column:
            if flag==1:
                print('++++++++++++++++++++++++++')
    ...
    workbook_name = "test_workbook_100"
